        ...
        <div className="max-w-md mx-auto">
          <Card className="bg-[#1A1A1A] border-[#333] glow-border">
            ...
            <CardContent>
              ...
              <div className="mt-6 p-4 bg-[#0D0D0D] rounded border border-[#333]">
                <h3 className="text-[#61E8E1] font-semibold mb-2">Demo Credentials:</h3>
                <div className="text-sm text-[#AAAAAA] space-y-1">
                  <p>
                    <strong>Admin:</strong> admin / safemode2024
                  </p>
                  <p>
