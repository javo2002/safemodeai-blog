...
// Define the structure for saved post data, including sources as an array
...
export default function CreatePost() {
  ...
  const handleSave = (postData: Omit<SavedPostData, "id" | "createdAt">) => {
    // Adjusted type for incoming data from PostEditor
    const savedPosts = localStorage.getItem("safemode-posts")
    const posts: SavedPostData[] = savedPosts ? JSON.parse(savedPosts) : []

    const newPost: SavedPostData = {
      ...postData,
